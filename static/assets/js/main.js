(function (b) {
	...
	b(function () {
		b("[data-bg-img]").css("background-image", function () {return 'url("' + b(this).data("bg-img") + '")'}).addClass("bg--img").removeAttr("data-bg-img");
		...
		a.on("ps-scroll-y", function () {localStorage.setItem("ps." + this.classList[0], this.scrollTop)});
		...
		(a = document.getElementById("morrisLineChart03")) && new Morris.Line({
			element: a.id,
			data: [{day: "S", a: 20}, {day: "M", a: 30}, {
				day: "T",
				a: 40
			}, {day: "W", a: 20}, {day: "T", a: 10}, {
				day: "F",
				a: 10
			}, {day: "S", a: 5}],
			xkey: "day",
		...
		(a = document.getElementById("morrisAreaChart03")) && new Morris.Area({
			element: a.id,
			data: [{month: "Ene", a: 0, b: 0, c: 0, d: 0}, {
				month: "Feb",
				a: 1200,
				b: 0,
				c: 0,
